...
3) Есть приложение, в нем есть поиск на главной странице, есть подсказки, есть поисковая выдача (фильтры, сортировки), в ней есть рекламные товары, деньги получаем с рекламы и комиссии пользователей. 
